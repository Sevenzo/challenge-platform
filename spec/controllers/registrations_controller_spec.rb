...
describe RegistrationsController do
  ...
  describe 'POST #update' do
    ...
    context 'when a user has digest frequency as `immediate`' do
      ...
      context 'for replies pending' do
        it 'should do no flush' do
          ...
          expect(updated_user.digest_frequency).to eq 'immediate'
        end
      end
    ...
    context 'when a user changes digest frequency back to `immediate`' do
