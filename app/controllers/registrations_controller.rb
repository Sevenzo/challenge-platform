class RegistrationsController < Devise::RegistrationsController
  ...
  def update
    ...
    # checking if it's digest frequency change back to immediate
...
private
  ...
  #
  # Checks if a user changed its email digest frequency back to `immediate`.
  ...
  def digest_frequency_updated?
    ...
    frequency == 'immediate' && frequency != resource.digest_frequency
  end
end
